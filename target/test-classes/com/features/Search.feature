Feature: Validate Ixigo Offers Page Navigation
  ...
  @6th 
  Scenario: Validate that the system shows No services available message
  Given the user launches the Ixigo bus website
  When  the user navigates to the Offers page
  And the user enters City in the From Station field
  And the user enters City in the To Station field

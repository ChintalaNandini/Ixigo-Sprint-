...
public class Profile extends BaseSteps {
	...
	public void the_user_clicks_on_the_track_ticket_option() {
		...
		bussearchpage = new BusSearchPage(driver, test); // OR use PageFactory
		bussearchpage.clickOnTrackTicket();
	...
	public void the_frequently_asked_questions_section_should_be_displayed() {
		...
		WebElement faqSection = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='faqs']/div[1]/h5")));
	...
	// @3rd Scenario=============================================
	BusSearchPage bussearchpage = new BusSearchPage(driver, test);

	@Given("User launches the Ixigo Website")
	public void user_launches_the_ixigo_website1() {
		// Initialize page object after driver is launched
		busSearchPage = new BusSearchPage(driver, test);
	}
	...
	public void user_enters_from_station_name_from_sheet_and_row_and_from_col(Integer sheet, Integer row,
			Integer fromCol) {
	...
	public void user_verifies_bus_details_page_is_displayed() {
		...
		//  Flexible XPath for results container
		WebElement busResultsContainer = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//*[@id='root']//div[contains(@class,'bus')] | //*[@id='root']/div/div/div[3]/div | //*[@id='root']/div")));

		Assert.assertTrue(busResultsContainer.isDisplayed());
	...
	public void user_selects_bus_type_filter_and_bus_list_gets_updated() {
		busType = reader.getCellData(1, 0, 2); // Sheet2, Row0, Col2
	...
	//6th Negative Scenario====================
	@Given("the user launches the Ixigo bus website")
	public void the_user_launches_the_ixigo_bus_website() {
		busSearchPage = new BusSearchPage(driver, test);
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}

	@When("the user navigates to the Offers page")
	public void the_user_navigates_to_the_offers_page() {
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}

	@When("the user enters City in the From Station field")
	public void the_user_enters_city_in_the_from_station_field() {
		busSearchPage.enterFromStation1();
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}

	@When("the user enters City in the To Station field")
	public void the_user_enters_city_in_the_to_station_field() {
		busSearchPage.enterToStation1();
	...
	public void the_user_clicks_on_the_search_button() {
		busSearchPage.clickSearchButton2();
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}
	@Then("the system should  validate and display the message")
	public void the_system_should_validate_and_display_the_message() {
		busSearchPage.isDisplayed();
...
//throw new io.cucumber.java.PendingException();
//	@Then("the system should validate and display the message")
//	public void the_system_should_validate_and_display_the_message(String expectedMessage) {
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//		WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(
//		        By.xpath("//*[@id=\"not-found-container\"]/div/h5")  ));
//		String actualMessage = messageElement.getText().trim();
//	    Assert.assertEquals(actualMessage, expectedMessage, "Message validation failed!");// Your XPath
//	    // Write code here that turns the phrase above into concrete actions
//	    //throw new io.cucumber.java.PendingException();
//	}
	

//@Then("the system should validateand display the message ")
//public void validateMessage() {
//    String expectedMessage = "There are no services on this route for the selected date. Select bus services available on alternative dates for this route";
//    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//    WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(
//        By.xpath("//*[@id=\"root\"]/div/div/div[2]/div,'There are no services')]")
//    ));
//    String actualMessage = messageElement.getText().trim();
...
//	@Then("the system should display the message There are no services on this route for the selected date. Select bus services available on alternative dates for this route")
//	public void the_system_should_validate_the_message_there_are_no_services_on_this_route_for_the_selected_date_select_bus_services_available_on_alternative_dates_for_this_route(String expectedMessage) {
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//		 WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(
//			        By.xpath("//*[@id=\"not-found-container\"]/div/h5",'There are no services') // Your XPath
//			        
//			    ));
//		 String actualMessage = messageElement.getText().trim();
...
//	@Then("the system should validate and display the message {string}")
//	public void the_system_should_validate_and_display_the_message(String expectedMessage) {
//	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//	    WebElement messageElement = wait.until(ExpectedConditions.visibilityOfElementLocated(
//	        By.xpath("//*[@id='root']/div/div/div[2]") // Your XPath
//	    ));
//
//	    String actualMessage = messageElement.getText().trim();
//	    Assert.assertEquals(actualMessage, expectedMessage, "Message validation failed!");
...
//    Assert.assertEquals("Message validation failed!", expectedMessage, actualMessage);
...
//WebElement busResultsContainer;
//
//try {
//    busResultsContainer = wait.until(ExpectedConditions.visibilityOfElementLocated(
//            By.xpath("//*[@id='root']/div/div/div[3]/div"))); // Chennai-Vijayawada
//} catch (TimeoutException e) {
//    busResultsContainer = wait.until(ExpectedConditions.visibilityOfElementLocated(
//            By.xpath("//*[@id=\"root\"]/div/div/div[3]/div"))); // Mumbai-Pune
//}
//
//Assert.assertTrue(busResultsContainer.isDisplayed());

// boolean isDisplayed = busSearchPage.isBusDetailsPagedispayed();
// Assert.assertTrue(isDisplayed,"Bus details page is not displayed");
// System.out.println("Bus details page is displayed sucessfully");
...
//    fromStation = reader.getCellData(1, 0, 0); // Sheet2, Row0, Col0
...
//    toStation = reader.getCellData(1, 0, 1); // Sheet2, Row0, Col1

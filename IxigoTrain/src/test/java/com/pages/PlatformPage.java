    ...
    public static boolean getSourceName(String source_name )
   	{
         ...
         try 
         {
             ...
             WebDriverWait suggestionWait = new WebDriverWait(driver, Duration.ofSeconds(10));
             By src1 = By.xpath("//div[@class='absolute z-20 top-[175px] left-20']//p[contains(normalize-space(text()),'"+source_name+"')]");
...
//	}
  ...
  //enter the destination in input text field 
    public static boolean getDestinationName(String destination_name )
      ...
      try 
      {
          ...
          WebDriverWait suggestionWait = new WebDriverWait(driver, Duration.ofSeconds(10));
          By des1 = By.xpath("//div[@class='absolute z-20 top-[175px] left-[420px]']//p[contains(normalize-space(text()),'"+destination_name+"')]");
  ...
  //=====================================fifth scenario=====================================================
   ...
   private static WebElement search_by_nameOrnumber;
  
   //enter name or number
   @FindBy(css="input[placeholder='Search trains by name or number']")
   private static WebElement enter_nameOrnumber;
   
   //view calender
     @FindBy(xpath="//a[text()='View 2 Months Calendar']")
     private static WebElement view_calender;
   
   // click on search by name/number
   public static boolean click_name_number()
   {
   	boolean actResult = true;
   	try {
 ...
 //Entering station name in input text field
   public static boolean enter_train_Name_Number(String train_name_number )
	{
		boolean actResult = true;
       try 
       {
           ...
           WebElement exactTrain1 = suggestionWait.until(ExpectedConditions.elementToBeClickable(By.xpath
        		   ("//div[@class='py-10 px-20']//div[@class='py-10']//p[contains(normalize-space(text()),'"+train_name_number+"')]")));
   ...
   public static boolean click_view_calender()
   {
   	boolean actResult = true;
   	try {
   	    WebDriverWait suggestionWait = new WebDriverWait(driver, Duration.ofSeconds(15));
        wait.until(ExpectedConditions.visibilityOf(view_calender));
 ...
 //verify seat availability page
   public static boolean verify_seat_availability_Page() {
       try {
    	   WebDriverWait suggestionWait = new WebDriverWait(driver, Duration.ofSeconds(15)); 
           String currentUrl = driver.getCurrentUrl();
           System.out.println("Current Page URL: " + currentUrl);

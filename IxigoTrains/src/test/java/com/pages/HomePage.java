...
//	//@FindBy(xpath="//p[text()='Trains']/ancestor::a")
//	@FindBy(xpath="(//p[contains(text(),'Trains')])[2]")
//	private WebElement trainslink;
//
//	@FindBy(xpath = "//a[contains(text(),'Order Food')]")
...
//	}
//	
//	public boolean clickTrainsLink() {
//		boolean actResult=true;
//		try {
//			new WebDriverWait(driver, Duration.ofSeconds(15))
//			.until(ExpectedConditions.elementToBeClickable(trainslink))
//			.click();
//			Reports.generateReport(driver, test, Status.PASS, "Trainslink is clicked");
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "Trainslink is not clicked");
//		}
//		return actResult;
//	}
//
//	public boolean clickOrderFoodLink() {
//		boolean actResult=true;
//		try {
//		new WebDriverWait(driver, Duration.ofSeconds(15))
//		.until(ExpectedConditions.visibilityOf(orderFoodLink));
//		orderFoodLink.click();
//		Reports.generateReport(driver, test, Status.PASS, "FoodOrder link is clicked" );
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "FoodOrder link is not clicked");
//		}
//		return actResult;
//	}
//
//	public boolean verifyFoodOptionsDisplayed() {
//		boolean actResult=true;
//		try {
////			boolean isDisplayed = new WebDriverWait(driver, Duration.ofSeconds(15))
//				wait.until(ExpectedConditions.visibilityOf(foodOptionsHeader));
////			if (!isDisplayed) {
////				throw new AssertionError("Order Food page not displayed!");
//				Reports.generateReport(driver, test, Status.PASS, "Food Options are displayed" );
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "Food Options are not displayed");
//		}
//		return actResult;
//	}
//	
//
//	public boolean exploreMore() {
//		boolean actResult=true;
//		try {
//		new WebDriverWait(driver, Duration.ofSeconds(15))
//		.until(ExpectedConditions.elementToBeClickable(text))
//		.click();
//		Reports.generateReport(driver, test, Status.PASS, "exploreMore Checked");
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "exploreMore is not Checked");
//		}
//		return actResult;
//	}
//	
//	// 2nd start from here 
//	
//	public boolean clickPlatformLocator() {
//		boolean actResult=true;
//		try {
//
//		Properties props = PropertyReader.readProperty();
...
//		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", trainPlatform);
//		wait.until(ExpectedConditions.elementToBeClickable(trainPlatform)).click();
//		Reports.generateReport(driver, test, Status.PASS, "Platform Loactor is clicked");
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "Platform Loactor is not clicked");
//		}
//		return actResult;
//	}
//
...
//	
//
//	public boolean clickTrainPlatform() {
//		boolean actResult = true;
//		try {
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//		wait.until(ExpectedConditions.elementToBeClickable(platformLocator));
//		Reports.generateReport(driver, test, Status.PASS, "Train Platform is clicked");
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "Train Plaform is not clicked");
//		}
//		return actResult;
//	}
//
...
//	
//	Map<String, String> formData;
//	public boolean clickPnrNum() {
//		boolean actResult = true;
//		try {
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//		wait.until(ExpectedConditions.elementToBeClickable(pnrInputField));
//		Reports.generateReport(driver, test, Status.PASS, "PNR number is clicked");
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "PNR number is not clicked");
//		}
//		return actResult;
//	}
//	
...
//	}
//	
////	public boolean enterTest(String[] TestName) throws IOException{
////		boolean actResult = true;
////		try {
////		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
////		((JavascriptExecutor)driver).executeScript("arguments[0].click();", pnrInputField);
////		pnrInputField.sendKeys(TestName);
////		System.out.println("DEBUG: Sent to search box -> " + TestName);
////		Reports.generateReport(driver, test, Status.PASS, "Text has been entered");
////		}
////		catch (TimeoutException te)
////		{
////			actResult=false;
////			Reports.generateReport(driver, test, Status.PASS, "Text has not been entered");
////		}
////		return actResult;
////		
////	}
...
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "Search button is not clicked");
//		}
//		return actResult;
//	}
//	
//	public boolean verifyAvailableStations() throws InterruptedException {
//		boolean actResult = true;
//		try {
//		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//		wait.until(ExpectedConditions.elementToBeClickable(searchStations));
//		Thread.sleep(2000);
//		Reports.generateReport(driver, test, Status.PASS, "Available Stations are verified");
//		}
//		catch (TimeoutException te)
//		{
//			actResult=false;
//			Reports.generateReport(driver, test, Status.PASS, "Available Stations are not verified");
//		}
//		return actResult;
//	}
//	
...
//      }
//  }
////	public boolean clickSeatAvailability() throws InterruptedException {
////		boolean actResult = true;
////		try {
////		//wait.until(ExpectedConditions.elementToBeClickable(seatAvailability));
////		//seatAvailability.click();
...
////		.click();
////		Thread.sleep(3000);
////		Reports.generateReport(driver, test, Status.PASS, "Seat Availability is clicked");
////		}
////		catch (TimeoutException te)
////		{
////			actResult=false;
////			Reports.generateReport(driver, test, Status.PASS, "Seat Availability is not clicked");
////		}
////		return actResult;
////	}
////    //enter the source in input text field
...
////  
////  //enter the destination in input text field
////  public boolean getDestinationName(String destination_name )
////	{
////	   boolean actResult = true;
////    try
////    {
...
//// 
////  //click on search  
////  public boolean click_On_search() {
////      boolean actResult = true;
////      try {
////    	  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
////           wait.until(ExpectedConditions.visibilityOf(search));
...
////  
////  //verify search page
////  public boolean verify_Train_Data_Page() {
////      try {
////    	  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
////    	  wait.until(ExpectedConditions.visibilityOf(verify_Trains_Availability_Page));
////          String currentUrl = driver.getCurrentUrl();
...
//      // 5th Scenario starts from here
//      
//      public boolean clickOffersPage() {
//    	  boolean actResult=true;
//    	  try {
//    	  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//  		wait.until(ExpectedConditions.elementToBeClickable(click_offers));
//  		click_offers.click();
//  		Reports.generateReport(driver, test, Status.PASS, "Offers page is clicked");
//    	  }
//    	  catch (TimeoutException te)
//    	  {
//    		  actResult = false;
//    		  Reports.generateReport(driver, test, Status.PASS, "Offers page is not clicked");
//    	  }
//		  return actResult;
//  		}
//    	  
//      
//      public boolean clicktrainoffers() throws InterruptedException {
//    	  boolean actResult=true;
//    	  try {
//    	  Thread.sleep(5000);
//    	  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
...
//      }
//      
//      public boolean verifyTrainOffers() throws InterruptedException {
//    	  boolean actResult=true;
//    	  try {
//  		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//  		wait.until(ExpectedConditions.elementToBeClickable(verify_offers));
